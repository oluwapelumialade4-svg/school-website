...
-- Student-Course Registration Table (Many-to-Many relationship)
CREATE TABLE student_courses (
    student_id BIGINT NOT NULL,
    course_id BIGINT NOT NULL,
    PRIMARY KEY (student_id, course_id),
    CONSTRAINT fk_student_courses_student FOREIGN KEY (student_id) REFERENCES users(id),
    CONSTRAINT fk_student_courses_course FOREIGN KEY (course_id) REFERENCES course(id)
);
